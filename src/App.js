...
function App() {
  ...
  return (
    <div style={{ textAlign: "center" }} className="app-mb">
      ...
      <div className="info" style={{ textAlign: "center" }}>
        ...
        >
          Upload an image and resize or convert below.
        </p>
      </div>
      <div className="upload-file" style={{ padding: "25px" }}>
          ...
          <div key={obj.value} className="buttons">
            ...
            >
              <div>
                ...
                <div>{obj.label}</div>
                <div variant="caption" component="div">{`${
                  obj.width || "auto"
                } × ${obj.height || "auto"}`}</div>
              </div>
            </button>
      ...
      <div className="download-wrapper">
        <a variant="contained" component="label" href={imageInfo} download>
          Download
        </a>
      </div>
      <div className="blub-info">
        <p style={{ fontSize: "12px" }}>
          Need more features? visit{" "}
          <a
            href="https://grapecake.com"
            style={{
              fontWeight: "bold",
              textDecoration: "none",
              color: "rgb(118, 1, 253)",
